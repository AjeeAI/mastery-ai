  ...
  return (
    <div className="overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div initial="hidden" animate="visible" variants={fadeInUp}>
            ...
            <div className="flex flex-wrap gap-4">
              <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3.5 rounded-full font-medium transition-all shadow-lg cursor-pointer hover:shadow-blue-500/30 hover:scale-105 duration-1000">
                Request a demo
              </button>
              <button className="flex items-center gap-2 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 px-8 py-3.5 rounded-full font-medium cursor-pointer transition-all hover:scale-105 duration-1000">
          ...
          >
            ...
            <div className="bg-slate-800 rounded-2xl p-4 shadow-2xl border border-slate-700 transform rotate-1 hover:rotate-0 transition-transform duration-500">
              <img 
                src="https://res.cloudinary.com/ddnxhqqkq/image/upload/v1772452896/Screenshot_2026-03-02_130112_kzingb.png" 
                alt="AI Dashboard" 
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative z-10 grid lg:grid-cols-5 gap-12 items-center">
            ...
            <div className="lg:col-span-2">
              ...
              <button className="text-white font-medium hover:text-slate-300 flex items-center gap-2 text-sm border-b border-white pb-1 w-fit">
        ...
        >
          <button className="bg-white text-slate-700 border border-slate-200 px-6 py-2.5 rounded-full font-semibold hover:bg-blue-700 hover:text-white transform hover:scale-105 duration-1000 transition-all cursor-pointer text-sm shadow-sm">
            Learn more
          </button>
          <button className="bg-white text-slate-700 border border-slate-200 px-6 py-2.5 rounded-full font-semibold text-sm shadow-sm flex items-center gap-2 hover:bg-blue-700 hover:text-white transform hover:scale-105 duration-1000 transition-all cursor-pointer">
        ...
        >
          ...
          <button className="mt-6 md:mt-0 bg-white text-blue-600 px-8 py-4 rounded-full font-bold shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all whitespace-nowrap transform hover:scale-105 duration-1000 cursor-pointer">
            Get Started Now
          </button>
        </motion.div>
      </section>
