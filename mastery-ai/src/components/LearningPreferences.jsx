  ...
  const handleContinue = async () => {
    ...
    try {
      const response = await fetch('', {
        ...
        body: JSON.stringify({ learningStyles: selectedStyles }),
      });
  ...
  return (
    <div className="min-h-screen font-sans p-8" style={{ backgroundColor: '#F9FAFB' }}>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-extrabold" style={{ color: '#111827' }}>How do you prefer to learn?</h1>
          ...
          {styles.map((style) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-lg font-bold mb-2" style={{ color: '#111827' }}>{style.title}</h3>
                <p className="text-xs leading-relaxed" style={{ color: '#6B7280' }}>{style.desc}</p>
              </div>
            );
          })}
        </div>
        ...
        <div className="border-t pt-8 flex items-center justify-between" style={{ borderColor: '#E5E7EB' }}>
          ...
          <button 
            ...
            style={{ 
              ...
              boxShadow: (isLoading || selectedStyles.length === 0) ? 'none' : '0 10px 15px -3px rgba(88, 80, 236, 0.3)',
