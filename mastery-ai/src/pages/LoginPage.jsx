...
const LoginPage = () => {
  ...
  // 1. Grab the login function from our AuthContext
  const { login } = useAuth();
  
  // Form state for the manual login
  const [formData, setFormData] = useState({ email: '', password: '' });

  // 2. Safely grab and clean the Client ID
  ...
  const handleManualSubmit = (e) => {
    e.preventDefault();
    console.log("Manual login attempt:", formData);
    // Future manual login hookup goes here
    navigate('/mastery-path');
  };
    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#6b46c1] relative flex-col items-center justify-center p-12 overflow-hidden">
        ...
        <div className="relative w-full max-w-lg z-10">
          ...
          {/* Floating Widget: Personalized Path */}
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div>
            ...
            <p className="text-slate-500 mt-3 text-sm leading-relaxed">
              Log in to continue your mastery journey on Spark AI.
            </p>
          </div>
          ...
          <form onSubmit={handleManualSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-4 py-3.5 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#6b46c1] focus:border-transparent transition-all placeholder:text-slate-300"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-12 py-3.5 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#6b46c1] focus:border-transparent transition-all placeholder:text-slate-300 tracking-widest"
                />
                <button 
                  type="button"
            ...
            <button 
              type="submit" 
              className="w-full bg-[#6b46c1] hover:bg-[#5b3da6] text-white font-bold py-3.5 rounded-xl transition-all shadow-lg shadow-indigo-500/30 flex justify-center items-center gap-2"
            >
              Sign In
          ...
          <p className="text-center text-sm text-slate-500 font-medium">
            New to Spark? <Link to="/register" className="text-[#6b46c1] font-bold hover:underline">Create an account</Link>
          </p>

        </div>

        {/* Bottom Small Links */}
        <div className="absolute bottom-8 flex gap-6 text-xs font-bold text-slate-400 uppercase tracking-widest">
